...
namespace Asilifelis.Data.Migrations.postgres
{
    ...
    [Migration("20240926195629_ActorLikes")]
    partial class ActorLikes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asilifelis.Models.ActorLikes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("LikedActorId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("LikesNoteId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("LikedActorId");

                    b.HasIndex("LikesNoteId");
            ...
            modelBuilder.Entity("Asilifelis.Models.ActorLikes", b =>
                {
                    b.HasOne("Asilifelis.Models.Actor", "Actor")
                        .WithMany()
                        .HasForeignKey("LikedActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Asilifelis.Models.Note", "Note")
                        .WithMany()
                        .HasForeignKey("LikesNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
